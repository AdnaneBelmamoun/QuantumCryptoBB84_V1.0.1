...
import qrypto.qommunication.BB84Qoding;
...
public class RawBB84 extends QProtocol implements Runnable{


    private String INITLOGFILENAME = Constants.RAWBB84SENDER;
    private String RESPLOGFILENAME = Constants.RAWBB84RECEIVER;
    
    
    public  static final int DEFAULT_N = 500;
    private static final String _CONF_LABEL = "Length of the raw key: ";
    public  static final String PROT_ID = "Raw BB84 transmission";
    private static final String _CLASSNAME = "RawBB84";

    protected BB84Qoding _bb84 = null;
    ...
    */
    ...
    public RawBB84(RemoteQConnection rqc, PubConnection pc){
	this();
	_qc = rqc;
	_pc = pc;
    }
    ...
    */
    public RawBB84(String me, String peer,int n,
  ...
  */
  ...
  /**
  * Returns the duration of the quantum transmission.
  * @param start is the time in millis when the protocol started
  * @param end is the tim ein millis then the protocol stopped.
  * @return the duration in seconds.
  */
  
  public static float duration(long start, long end){
    return (new Long(end-start).floatValue())/1000.0f;
  }
  ...
  */
  ...
  public void run() throws RuntimeQryptoException{
   try{
	...
	_logfile = new Log(s, true, "RawBB84");
	_logfile.header();
  ...
  */
  ...
  private void runningPatch(boolean init)throws QryptoException{
    ...
    _bb84 = new BB84Qoding(_n,_me,_peer,init,_logfile);
    _qc.setProc(_bb84,init);
...
public void addMyHoles(Hashtable ht, int instanceNumber){
    ...
    String s = null;
    switch(_bb84.getQType()){
	case Constants.VIRTUAL: s="VIRTUAL"; break;
	case Constants.REAL   : s="REAL"; break;
	default               : s="UNDEFINED";
    }
    int bs = _bb84.getBucketSize();
    int nb = _bb84.getNumberOfBuckets();
    ...
    o[7] = new toHtmlString("time",new Float(duration(_startTime,_endTime)).toString());
    o[8] = new toHtmlString("rate",Float.toString(rate));
    o[9] = new toHtmlString("qubits",QuBit.array2Html(getOutput(),10,5));  
    a = new argElm(RawBB84._CLASSNAME+"+"+instanceNumber,instanceNumber,null, o);
    ht.put(RawBB84._CLASSNAME+"+"+instanceNumber,a);
  }
